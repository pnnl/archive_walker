...
Public Class DetectorConfig
    ...
    Public Sub New()
        ...
        _detectorNameList = New List(Of String) From {"Periodogram",
                                                      "SpectralCoherence",
                                                      "Ringdown",
                                                      "OutOfRangeGeneral",
                                                      "OutOfRangeFrequency",
                                                      "WindRamp"}
        _alarmingDetectorNameList = New List(Of String) From {"Periodogram",
                                                              "SpectralCoherence",
                                                              "Ringdown"}
    End Sub
...
Public Class PeriodogramDetector
    ...
    Public Property Pfa As String
        ...
        End Set
    End Property
    Private _frequencyMin As Double
    Public Property FrequencyMin As Double
        ...
        End Set
    End Property
    Private _frequencyMax As Double
