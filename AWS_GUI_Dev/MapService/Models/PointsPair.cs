...
namespace MapService.Models
{
    public class PointsPair
    {
        public PointsPair(CartesianPoint pointLatLng1, CartesianPoint pointLatLng2)
        {
            ...
            var T1 = Vector<double>.Build.DenseOfArray(Generate.LinearSpaced(NumberOfPointsForEachCurve, Ts1[0], Ts1[1]));
            ...
            AngleCenter2Point1 = Math.Atan2(Y1 - Center2.Y, X1 - Center2.X);
            AngleCenter2Point2 = Math.Atan2(Y2 - Center2.Y, X2 - Center2.X);
            var Ts2 = Utility.UnWrap(new List<double> { AngleCenter2Point1, AngleCenter2Point2 });
            var T2 = Vector<double>.Build.DenseOfArray(Generate.LinearSpaced(NumberOfPointsForEachCurve, Ts2[0], Ts2[1]));
        ...
        public int NumberOfPointsForEachCurve { get; set; } = 101;
