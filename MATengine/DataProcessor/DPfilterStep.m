        ...
        case 'RunningAverage'
            for PMUidx = 1:NumPMU
               % If the PMU doesn't exist, skip to next index
                ...
                [PMU(PMUstructIdx(PMUidx)), FinalCondos{FiltIdx}{PMUidx}] = RunningAveFilt(PMU(PMUstructIdx(PMUidx)),PMUchans(PMUidx).ChansToFilt,Parameters, InitialCondos{FiltIdx}{PMUidx});
            end
        ...
        case 'RMSenergyFilt'
            for PMUidx = 1:NumPMU
               % If the PMU doesn't exist, skip to next index
                ...
                [PMU(PMUstructIdx(PMUidx)), FinalCondos{FiltIdx}{PMUidx}] = RMSenergyFilt(PMU(PMUstructIdx(PMUidx)),PMUchans(PMUidx).ChansToFilt,Parameters, InitialCondos{FiltIdx}{PMUidx});
            end
    end
end
