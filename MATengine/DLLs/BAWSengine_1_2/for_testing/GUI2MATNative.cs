...
* Date: Fri Jul 20 13:26:02 2018
* Arguments:
* "-B""macro_default""-W""dotnet:BAWSengine,GUI2MAT,4.0,private""-T""link:lib""-d""C:\User
* s\foll154\Documents\BPAoscillationApp\CodeForProject2\DataReaderCode\DLLs\BAWSengine_1_2
* \for_testing""-v""class{GUI2MAT:C:\Users\foll154\Documents\BPAoscillationApp\CodeForProj
* ect2\DataReaderCode\GUIfunctions\GetPDATexample.m,C:\Users\foll154\Documents\BPAoscillat
* ionApp\CodeForProject2\DataReaderCode\GUIfunctions\GetSparseData.m,C:\Users\foll154\Docu
* ments\BPAoscillationApp\CodeForProject2\DataReaderCode\GUIfunctions\RerunForcedOscillati
* on.m,C:\Users\foll154\Documents\BPAoscillationApp\CodeForProject2\DataReaderCode\GUIfunc
* tions\RerunOutOfRange.m,C:\Users\foll154\Documents\BPAoscillationApp\CodeForProject2\Dat
* aReaderCode\GUIfunctions\RerunRingdown.m,C:\Users\foll154\Documents\BPAoscillationApp\Co
* deForProject2\DataReaderCode\GUIfunctions\RerunThevenin.m,C:\Users\foll154\Documents\BPA
* oscillationApp\CodeForProject2\DataReaderCode\GUIfunctions\RunNormalMode.m}""-a""C:\User
* s\foll154\Documents\BPAoscillationApp\CodeForProject2\DataReaderCode\Rerun\AddMissingToS
* parsePMU.m""-a""C:\Users\foll154\Documents\BPAoscillationApp\CodeForProject2\DataReaderC
* ode\Rerun\AddToSparsePMU.m""-a""C:\Users\foll154\Documents\BPAoscillationApp\CodeForProj
* ect2\DataReaderCode\Rerun\CleanAdditionalOutput.m""-a""C:\Users\foll154\Documents\BPAosc
* illationApp\CodeForProject2\DataReaderCode\Rerun\DisableDetectors.m""-a""C:\Users\foll15
* 4\Documents\BPAoscillationApp\CodeForProject2\DataReaderCode\Rerun\RetrieveInitializatio
* nFile.m"
*/
using System;
...
namespace BAWSengineNative
{
  ...
  /// <newpara></newpara>
  /// C:\Users\foll154\Documents\BPAoscillationApp\CodeForProject2\DataReaderCode\GUIfunct
  /// ions\GetPDATexample.m
  /// <newpara></newpara>
  /// C:\Users\foll154\Documents\BPAoscillationApp\CodeForProject2\DataReaderCode\GUIfunct
  /// ions\GetSparseData.m
  /// <newpara></newpara>
  /// C:\Users\foll154\Documents\BPAoscillationApp\CodeForProject2\DataReaderCode\GUIfunct
  /// ions\RerunForcedOscillation.m
  /// <newpara></newpara>
  /// C:\Users\foll154\Documents\BPAoscillationApp\CodeForProject2\DataReaderCode\GUIfunct
  /// ions\RerunOutOfRange.m
  /// <newpara></newpara>
  /// C:\Users\foll154\Documents\BPAoscillationApp\CodeForProject2\DataReaderCode\GUIfunct
  /// ions\RerunRingdown.m
  /// <newpara></newpara>
  /// C:\Users\foll154\Documents\BPAoscillationApp\CodeForProject2\DataReaderCode\GUIfunct
  /// ions\RerunThevenin.m
  /// <newpara></newpara>
  /// C:\Users\foll154\Documents\BPAoscillationApp\CodeForProject2\DataReaderCode\GUIfunct
  /// ions\RunNormalMode.m
  /// </summary>
  /// <remarks>
  /// @Version 4.0
  /// </remarks>
  public class GUI2MAT : IDisposable
  {
    ...
    public Object GetSparseData(Object SparseStartTime, Object SparseEndTime, Object 
                          ConfigFile)
    {
      return mcr.EvaluateFunction("GetSparseData", SparseStartTime, SparseEndTime, ConfigFile);
    }
    ...
    ///
    public Object GetSparseData(Object SparseStartTime, Object SparseEndTime, Object 
                          ConfigFile, Object SparseDetector)
    {
      return mcr.EvaluateFunction("GetSparseData", SparseStartTime, SparseEndTime, ConfigFile, SparseDetector);
    }
    ...
    ///
    public Object[] GetSparseData(int numArgsOut, Object SparseStartTime, Object 
                            SparseEndTime, Object ConfigFile)
    {
      return mcr.EvaluateFunction(numArgsOut, "GetSparseData", SparseStartTime, SparseEndTime, ConfigFile);
    }
    ...
    ///
    public Object[] GetSparseData(int numArgsOut, Object SparseStartTime, Object 
                            SparseEndTime, Object ConfigFile, Object SparseDetector)
    {
      return mcr.EvaluateFunction(numArgsOut, "GetSparseData", SparseStartTime, SparseEndTime, ConfigFile, SparseDetector);
    }
    ...
    /// arguments</param>
    ///
    [MATLABSignature("RerunForcedOscillation", 4, 1, 0)]
    ...
    /// <param name="RerunEndTime">Input argument #2</param>
    /// <param name="ConfigFile">Input argument #3</param>
    /// <param name="RerunDetector">Input argument #4</param>
    /// <returns>An Object containing the first output argument.</returns>
    ///
    public Object RerunOutOfRange(Object RerunStartTime, Object RerunEndTime, Object 
                            ConfigFile, Object RerunDetector)
    {
      return mcr.EvaluateFunction("RerunOutOfRange", RerunStartTime, RerunEndTime, ConfigFile, RerunDetector);
    }
    ...
    /// <param name="ConfigFile">Input argument #3</param>
    /// <param name="RerunDetector">Input argument #4</param>
    /// <param name="ControlPath">Input argument #5</param>
    /// <returns>An Object containing the first output argument.</returns>
    ///
    public Object RerunOutOfRange(Object RerunStartTime, Object RerunEndTime, Object 
                            ConfigFile, Object RerunDetector, Object ControlPath)
    {
      return mcr.EvaluateFunction("RerunOutOfRange", RerunStartTime, RerunEndTime, ConfigFile, RerunDetector, ControlPath);
    }
    ...
    ///
    public Object[] RerunOutOfRange(int numArgsOut, Object RerunStartTime, Object 
                              RerunEndTime, Object ConfigFile, Object RerunDetector)
    {
      return mcr.EvaluateFunction(numArgsOut, "RerunOutOfRange", RerunStartTime, RerunEndTime, ConfigFile, RerunDetector);
    }
    ...
    public Object[] RerunOutOfRange(int numArgsOut, Object RerunStartTime, Object 
                              ...
                              Object ControlPath)
    {
      return mcr.EvaluateFunction(numArgsOut, "RerunOutOfRange", RerunStartTime, RerunEndTime, ConfigFile, RerunDetector, ControlPath);
    }
    ...
    /// arguments</param>
    ///
    [MATLABSignature("RerunOutOfRange", 5, 1, 0)]
    ...
    /// arguments</param>
    ///
    [MATLABSignature("RerunRingdown", 4, 1, 0)]
    ...
    /// <param name="ConfigFile">Input argument #3</param>
    /// <param name="ControlPath">Input argument #4</param>
    /// <param name="PredictionDelay">Input argument #5</param>
    /// <returns>An Object containing the first output argument.</returns>
    ///
    public Object RerunThevenin(Object RerunStartTime, Object RerunEndTime, Object 
                          ConfigFile, Object ControlPath, Object PredictionDelay)
    {
      return mcr.EvaluateFunction("RerunThevenin", RerunStartTime, RerunEndTime, ConfigFile, ControlPath, PredictionDelay);
    }
    ...
    public Object[] RerunThevenin(int numArgsOut, Object RerunStartTime, Object 
                            ...
                            PredictionDelay)
    {
      return mcr.EvaluateFunction(numArgsOut, "RerunThevenin", RerunStartTime, RerunEndTime, ConfigFile, ControlPath, PredictionDelay);
    }
    ...
    /// arguments</param>
    ///
    [MATLABSignature("RerunThevenin", 5, 1, 0)]
    ...
    /// </remarks>
    /// <param name="ControlPath">Input argument #1</param>
    /// <param name="ConfigFile">Input argument #2</param>
    ///
    public void RunNormalMode(Object ControlPath, Object ConfigFile)
    {
      mcr.EvaluateFunction(0, "RunNormalMode", ControlPath, ConfigFile);
    }
    ...
    /// arguments.</returns>
    ///
    public Object[] RunNormalMode(int numArgsOut, Object ControlPath, Object ConfigFile)
    {
      return mcr.EvaluateFunction(numArgsOut, "RunNormalMode", ControlPath, ConfigFile);
    }
    ...
    /// arguments</param>
    ///
    [MATLABSignature("RunNormalMode", 2, 0, 0)]
