...
% PMU(1).Signal_Time.Signal_datenum(3) = [];

PMU(1).Data(1:1800,1) =  500000;%280000.0*ones(1800,1);
% PMU(1).Signal_Time.Signal_datenum(20:30) = [];
% PMU(1).Data(1:1000,1) =  280000.0*ones(1000,1);
% PMU(1).Signal_Time.Signal_datenum(100) = [];
% PMU(1).Stat(1:1000,1)= (2^15+2^14+ 2^12 + 2^13)*ones(1000,1);
